...
| `nginx.conf`, `.github/workflows/back-dev.yml`, `README.md` | Выпуск | 19 |
...
**Files:**
- Modify: `nginx.conf`, `.github/workflows/back-dev.yml`, `README.md`
...
- [ ] **Step 3: Линтер и тесты в CI — `.github/workflows/back-dev.yml`**
...
```bash
git add nginx.conf .github/workflows/back-dev.yml README.md
